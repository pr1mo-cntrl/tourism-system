        ...
        return $schema
            ->components([
                Wizard::make([
                    ...
                    // PAGE 1: ESTABLISHMENT INFORMATION
                    Step::make('Establishment Information')
                        ->description('Enter the basic details of the establishment, rooms, and employees.')
                        ->schema([
                            Select::make('name') 
                    ...
                    // PAGE 2: GUEST DEMOGRAPHICS & METRICS
                    Step::make('Guest Demographics & Metrics')
                        ->description('Input guest arrivals breakdown by residency and room occupancy.')
                        ->schema([
