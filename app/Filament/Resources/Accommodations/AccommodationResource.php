        ...
        return $schema
            ->components([
                ...
                Placeholder::make('heading_info')
                    ...
                    ->content('Enter the basic details of the establishment, rooms, and employees.'),
                ...
                Placeholder::make('heading_metrics')
                    ->label('GUEST DEMOGRAPHICS & METRICS')
                    ->content('Input guest arrivals breakdown by residency and room occupancy.'),
